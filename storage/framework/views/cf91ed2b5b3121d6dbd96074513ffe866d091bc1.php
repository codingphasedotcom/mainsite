...
<html lang="<?php echo e(config('app.locale')); ?>">
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="<?php echo e(url('/adminlte')); ?>/plugins/iCheck/flat/blue.css">
        <!-- Morris chart -->
        <link rel="stylesheet" href="<?php echo e(url('/adminlte')); ?>/plugins/morris/morris.css">
        <!-- jvectormap -->
        <link rel="stylesheet" href="<?php echo e(url('/adminlte')); ?>/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
        <!-- Date Picker -->
        <link rel="stylesheet" href="<?php echo e(url('/adminlte')); ?>/plugins/datepicker/datepicker3.css">
        <!-- Daterange picker -->
    ...
    <div class="wrapper">
      ...
      <!-- jQuery 2.2.3 -->
      <script src="<?php echo e(url('/adminlte')); ?>/plugins/jQuery/jquery-2.2.3.min.js"></script>
      <!-- jQuery UI 1.11.4 -->
      ...
      <script src="<?php echo e(url('/adminlte')); ?>/plugins/morris/morris.min.js"></script>
      <!-- Sparkline -->
      <script src="<?php echo e(url('/adminlte')); ?>/plugins/sparkline/jquery.sparkline.min.js"></script>
      <!-- jvectormap -->
      ...
      <!-- jQuery Knob Chart -->
      <script src="<?php echo e(url('/adminlte')); ?>/plugins/knob/jquery.knob.js"></script>
      <!-- daterangepicker -->
      <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
      <script src="<?php echo e(url('/adminlte')); ?>/plugins/daterangepicker/daterangepicker.js"></script>
      <!-- datepicker -->
      <script src="<?php echo e(url('/adminlte')); ?>/plugins/datepicker/bootstrap-datepicker.js"></script>
      <!-- Bootstrap WYSIHTML5 -->
      ...
      <!-- AdminLTE App -->
      <script src="<?php echo e(url('/adminlte')); ?>/dist/js/app.min.js"></script>
